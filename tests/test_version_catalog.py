...
class VersionCatalogTests(unittest.TestCase):
    ...
    def test_release_tags_are_scoped_to_independent_artifacts(self):
        ...
        self.assertEqual(
            ...
            {
                "suite": "suite/v0.26.1-beta",
                "edge-os": "edge-os/v0.26.1-beta",
                "ios": "ios/v0.25.2-beta",
                "call": "call/v0.25.1-beta",
            },
        )
        self.assertEqual(VERSIONCTL.validate_tag(catalog, "edge-os/v0.26.1-beta"), [])
        self.assertTrue(VERSIONCTL.validate_tag(catalog, "v0.26.1"))
