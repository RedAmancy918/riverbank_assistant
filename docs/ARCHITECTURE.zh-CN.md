...
当前架构基线：**RiverBank Edge OS v0.26.2 beta**，分发模式为 `managed-linux-system-layer`。可烧录系统镜像与 A/B OTA 是下一阶段交付能力，见 `docs/EDGE_OS.zh-CN.md`。
