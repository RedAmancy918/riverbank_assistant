...
当前设备操作系统基线：**RiverBank Edge OS v0.26.2 beta**。本页与设备桌面维护副本以该基线同步；上游 Debian/Raspberry Pi OS 版本单独报告，不作为 Edge OS 版本号。
...
sudo python3 apps/release-manager/release_manager.py seal \
  --version v0.26.2 --channel beta --notes "release summary"
