...
COMPONENTS = (
    ...
    },
    {
        ...
        "files": (
            ...
            repository_file("apps/paper-radar/hermes/paper-radar-collect.sh"),
            repository_file("apps/paper-radar/hermes/paper-radar-preview.sh"),
            repository_file("apps/paper-radar/scripts/align_hermes_job.py"),
            repository_file("apps/paper-radar/scripts/arxiv_access.py"),
            repository_file("apps/paper-radar/scripts/catchup.py"),
            ...
            repository_file("apps/paper-radar/static/site.css"),
            repository_file("apps/paper-radar/templates/report.html"),
            "/etc/systemd/system/paper-radar-catchup.service",
            "/etc/systemd/system/paper-radar-catchup.timer",
