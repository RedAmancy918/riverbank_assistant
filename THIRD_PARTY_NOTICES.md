...
This repository contains integration code and configuration references for
third-party software, but does not redistribute those projects or their data.
...
- Expression GIFs and wake acknowledgement audio are not included.

The RiverBank name and logos are brand assets. Their inclusion in this snapshot
does not by itself grant trademark rights; the repository owner should publish a
separate brand-use policy.
